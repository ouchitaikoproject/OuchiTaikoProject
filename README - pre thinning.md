...
The components you will be mounting to the board are as follows:
...
- **0.1F Ceramic Capacitors** part of protection circuit
...
4. The controller will reboot into the new controller mode

---

## **Auto Calibrate - Quick Start Guide**

**Recommended for all users - fully guided, no PC required**

Auto Calibrate automatically determines optimal thresholds for your specific drum build and playing force.
...
### **Wizard Flow (current firmware):**

The wizard is guided **one pad at a time** in this order:
- **Ka Left -> Don Left -> Don Right -> Ka Right**

For each pad, the firmware runs:
1. **NORMAL** hits: perform 3 normal hits
2. **STRONG** hits: perform 3 strong hits
3. **RAPID** hits: rapid-hit that same pad for the timed roll window

Then the wizard moves to the next pad automatically.

After all 4 pads:
- **Review Results** screen appears briefly
- Thresholds are **auto-applied and saved**
- Wizard exits automatically back to normal operation

### **What the System Analyzes:**

- **Maximum song force:** The maximum you would use during a song
...
- Peak values are too low for your song-level hits
- Crosstalk exceeds 50% of hit strength - mechanical isolation issue

Pro tip: Use the maximum you would use during a song, not a force level beyond normal gameplay.
